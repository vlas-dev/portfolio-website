...
const Projects = () => {
  ...
  return (
    <div
      name="/projects"
      className="flex justify-center items-center pb-20 w-full bg-gray-200 dark:bg-[#1a1a1a] dark:text-gray-300 text-gray-700 pt-20 md:pt-36 sm:pl-4 sm:pr-4 md:h-screen transition-colors duration-200"
    >
      <motion.div
