  ...
  return (
    ...
    >
      <div className="max-w-[1000px] max-h-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full  md:pb-32">
        <div>
          <p className="text-4xl font-bold inline border-b-4 text-[#0f0f0f] border-[#504f5f] ">
            Projects
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 py-10">
          ...
          >
            ...
            <div className="hidden md:group-hover:block group-focus:block absolute inset-0 backdrop-filter backdrop-blur-md rounded-md overflow-hidden pt-3">
              ...
              <p className="text-1xl text-white max-w-[500px] pt-7 pb-5 font-bold "
          ...
          >
            ...
            <div className="hidden md:group-hover:block group-focus:block absolute inset-0 backdrop-filter backdrop-blur-md rounded-md overflow-hidden pt-3">
              ...
              <p className="text-1xl text-white max-w-[500px] pt-5 pb-1  font-bold "
               style={{ textShadow: '0px 0px 2px #000' }}>
                Fetches and displays the current weather for
                a city using the OpenWeatherMap API. Users can view the weather
                in Celsius or Fahrenheit units and enable location-based weather
                retrieval.
              </p>
          ...
          >
            ...
            <div className="hidden md:group-hover:block group-focus:block absolute inset-0 backdrop-filter backdrop-blur-md rounded-md overflow-hidden pt-3">
              ...
              <p className="text-1xl text-white max-w-[500px] pt-5 pb-1  font-bold " 
                             style={{ textShadow: '0px 0px 2px #000' }}
                             >
                This app presents a series of shuffling images. Avoid clicking
                the same image twice to maintain your score. Test your memory
                and aim for the highest score possible.
              </p>
