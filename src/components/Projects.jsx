          ...
          <div className="shadow-md shadow-[#040c16] container rounded-md mx-auto transform ease-in-out overflow-hidden flex flex-col">
            ...
            <div className="text-center pt-4 pb-4 mb-4">
              <a
                ...
                className="text-center px-4 py-2 m-2  text-white border-2 border-[#fd004f] hover:dark:border-white bg-[#fd004f] hover:bg-white hover:text-gray-600 font-bold text-lg transition-colors duration-200"
              >
                Live
              </a>
              <a
